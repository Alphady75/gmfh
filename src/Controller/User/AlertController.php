...
class AlertController extends AbstractController
{
    ...
    #[Route('/', name: 'user_alert_index', methods: ['GET'])]
    ...
    #[Route('/nouvelle-alerte', name: 'user_alert_new', methods: ['GET', 'POST'])]
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('user_alert_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('user/alert/new.html.twig', [
            'alert' => $alert,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'user_alert_show', methods: ['GET'])]
    public function show(Alert $alert): Response
    {
        return $this->render('user/alert/show.html.twig', [
            'alert' => $alert,
        ]);
    }

    #[Route('/{id}/edit', name: 'user_alert_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Alert $alert, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('user/alert/edit.html.twig', [
            'alert' => $alert,
            'form' => $form,
        ]);
    }

    #[Route('/delete/{id}', name: 'user_alert_delete', methods: ['POST'])]
    public function delete(Request $request, Alert $alert, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete' . $alert->getId(), $request->request->get('_token'))) {
            ...
            $entityManager->flush();
            $this->addFlash('success', "Votre alerte d'offre d'emploi a bien été supprimée");
        }

        return $this->redirect($request->headers->get('referer'));
    }

    #[Route('/remove/{id}', name: 'user_alert_remove', methods: ['GET'])]
    ...
    #[Route('/desactive/{id}', name: 'user_alert_desactive', methods: ['POST'])]
