...
class PostType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('imageDeuxFile', VichImageType::class, [
                'label' => false,
                'required' => false
            ])
            ->add('imageTroisFile', VichImageType::class, [
                'label' => false,
                'required' => false
            ])
            ...
            ->add('description', TextareaType::class, [
                'label' => false,
                'help' => "Décrivez votre service en quelques lignes.",
                'required' => false,
                'attr' => [
    ...
    private function addCategorieFields($form, ?Categorie $categorie)
    {
        ...
        $builder = $form->getConfig()->getFormFactory()->createNamedBuilder(
            ...
            null,
            [
                'label' => "Sous-catégorie du service",
                'class' =>  SousCategorie::class,
